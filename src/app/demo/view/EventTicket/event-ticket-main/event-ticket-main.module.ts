...
import { EventTicketMainRoutingModule } from './event-ticket-main-routing.module';
import { EventTicketListComponent } from '../event-ticket-list/event-ticket-list.component';


@NgModule({
    declarations: [EventTicketMainComponent,EventTicketListComponent
    ],
    imports: [
        CommonModule,
        EventTicketMainRoutingModule,
        TableModule,
        TabViewModule,
        PanelModule,
        ButtonModule,
...
export class EventTicketMainModule { }
