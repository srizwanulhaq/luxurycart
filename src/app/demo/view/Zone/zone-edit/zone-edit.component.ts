...
export class ZoneEditComponent implements OnInit {
  ...
  driveModeDropDown:DriveModeDropDown[];
    ...
    nextPage(e) {
        this.submitted = true;
        if (this.zoneEditForm.value.title &&
            this.zoneEditForm.value.zone_Type_Id && this.zoneEditForm.value.city_Id && this.zoneEditForm.value.country_Id) {
            if (e === 3) {
                ...
                if (this.activeIndex == 0) {
                    ...
                    this.activeIndex = this.activeIndex + 1;
                    // if (this.zoneEditForm.value.min_Wallet_Balance ) 
                    // {
                    //     this.activeIndex = this.activeIndex + 1;
                    //     this.submitted = false;
                    // }
                    ...
                    if (this.zoneEditForm.value.zone_Coordinates.length > 0 || this.zoneCordinates.length > 0 || this.zoneCordinates2.length > 0) {
                        this.activeIndex = this.activeIndex + 1;
                        this.submitted = false;
                    }
                }
                else if (this.activeIndex == 3) {
                    if (this.zoneFare.length >= 0) {
                        this.activeIndex = this.activeIndex + 1;
                        this.submitted = false;
                    }
                }
    ...
    loadForm() {
        this.zoneEditForm = this._formBuilder.group({
            ...
            ride_scrutiny_setting2: this._formBuilder.array([]),
            ride_scrutiny_setting3: this._formBuilder.array([]),
